    ...
    <div className="min-h-[calc(100vh-4rem)]">
      ...
      <section className="relative overflow-hidden px-4 py-24 md:py-36">
        ...
        >
          ...
          <motion.p variants={fadeUp} transition={{ duration: 0.6 }} className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground md:text-xl">
          ...
          <motion.div
            ...
            className="mx-auto mt-16 max-w-2xl overflow-hidden rounded-xl border border-border bg-card shadow-2xl shadow-primary/5"
          >
      ...
      <section className="border-t border-border px-4 py-20">
        <div className="container mx-auto">
          <motion.div
            ...
            className="mx-auto max-w-3xl rounded-2xl border border-primary/20 bg-gradient-to-br from-primary/5 via-card to-accent/5 p-10 text-center md:p-16"
          >
